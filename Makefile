...
BETA_VERSION ?=
DOCKER_IMAGE_NAME = biarms/squid
DOCKER_IMAGE_VERSION = 3.5.27
SOFTWARE_VERSION = 3.5.27
...
run-smoke-tests: prepare
	...
	docker run --rm "$(MULTI_ARCH_DOCKER_IMAGE_TAGNAME)" squid -v | grep "$(DOCKER_IMAGE_VERSION)"
